...
import com.ebay.hooks.Hooks;
import com.ebay.pages.HomePage;
import com.ebay.pages.SearchResultsPage;
import com.lendInvest.api.ApiTests;

import cucumber.api.java.en.*;

public class LendInvestStepDef {

	WebDriver driver = Hooks.getDriver();
	HomePage homepage = new HomePage(driver);
	ApiTests api = new ApiTests();
	...
	public void user_launch_the_ebay_application() throws Throwable {
		String url = Constants.ebayApp_Url;
	...
	public void user_validates_the_GET_request() throws Throwable {
		api.test_GetAndValidateLocations_ShouldBe4();
		api.test_GetAndValidateLocations();
	}

	@Given("^User validates the POST request$")
	public void user_validates_the_POST_request() throws Throwable {
		api.test_PostAndValidateLocations();
	}
